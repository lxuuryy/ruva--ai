...
export const MacbookScroll = ({
  ...
  const textOpacity2 = useTransform(scrollYProgress, [0.3, 0.4], [0, 1]);

  return (
    <div
      ref={ref}
      className=" min-h-[200vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.55] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            Ruva is the future of mock interviews
          </span>
        )}
      </motion.h2>
      {/* Lid */}
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute left-0 right-0 bg-[#272729] rounded-lg" />
        <Image
          src={'/Capture.PNG'}
          alt="aceternity logo"
          fill
